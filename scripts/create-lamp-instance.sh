...
# Automates deployment of a LAMP stack on AWS
# Author: Khwezi Maphumulo
# Date: 2026-09-22
# ============================================================
...
# Get AMI ID
imageId=$(aws ssm get-parameters --names '/aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2' --profile $profile --region $region --query 'Parameters[0].Value' --output text)
echo "AMI ID: "$imageId
